    ...
    <div className='flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-col w-full h-auto items-center justify-center text-textcolor'>
        <div className='flex flex-col container max-w-[800px] items-center justify-center '>
          <p className='mt-10 text-4xl font-semibold text-center text-texthead'>Delivering the Customer View of Mobile Networks</p>
          <p className='mt-10 font-semibold text-center text-[20px] text-texthead'>Bringing clarity to wide-ranging use cases, Endeavour Technology assures the best possible customer experience</p>
