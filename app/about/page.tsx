...
const page = () => {
  return (
    <div className='flex flex-col items-center justify-center bg-white h-full w-full'>
      ...
      <div className='flex flex-col items-center justify-center bg-gradient-to-b from-[#FBFBFC] to-[#FFFFFF] h-full w-full'>
        <div className='flex flex-col items-center  justify-center container max-w-[1000px] p-10'>
