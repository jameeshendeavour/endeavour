  ...
  return (
    <AnimatePresence>
      <div className="z-[20] flex flex-col items-center justify-center h-full w-full max-w-[1200px] text-textcolor ">
        <p className='text-xl mt-10 mb-10 text-texthead'> Ensure Experience Exceeds Expectations </p>
        <p className='text-4xl font-semibold mx-10 text-center text-texthead'> We provide the platform and data analytics that optimise performance of devices around the world. </p>
